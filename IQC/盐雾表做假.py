...
file2_path = 'F:/system/Desktop/盐雾实验记录.xlsx'
# 使用前注意删除不良汇总避免干扰
# Define the keywords to look for in column C
keywords = ["T铁", "U铁", "华司", "端子板", "盆架", "上壳"]
...
updated_file2_path = 'F:/system/Desktop/盐雾实验记录.xlsx'
...
# 加载 Excel 工作簿
wb = openpyxl.load_workbook('F:/system/Desktop/盐雾实验记录.xlsx')
...
# 保存工作簿
wb.save('F:/system/Desktop/盐雾实验记录.xlsx')
