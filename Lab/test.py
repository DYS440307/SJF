...
def generate_random_numbers(existing_values, value_range):
    ...
    for _ in range(max_attempts):
        ...
        # 生成较大值（C列、E列、F列或I列），比前者大至少min_diff
...
def write_to_excel(file_path):
    try:
        ...
        RANGE_3 = (76.8, 78.6, 0.32)  # 范围3配置：最小值，最大值，最小差值
        RANGE_4 = (9.4, 13.9, 1.21)  # 范围4配置：最小值，最大值，最小差值

        # 对B12:C16、D12:E16、F12:G16和H12:I16的每个单元格对进行操作
